...
final class VersionSliderElement extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE slider_element (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, event_id INT DEFAULT NULL, lang_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', active TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(123) NOT NULL, slider_position INT NOT NULL, title LONGTEXT NOT NULL, subtitle LONGTEXT DEFAULT NULL, url VARCHAR(255) NOT NULL, dates VARCHAR(255) DEFAULT NULL, display_event TINYINT(1) NOT NULL, language_group BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_3FBB7B95989D9B62 (slug), INDEX IDX_3FBB7B953DA5256D (image_id), INDEX IDX_3FBB7B9571F7E88B (event_id), INDEX IDX_3FBB7B95B213FA4 (lang_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE slider_element ADD CONSTRAINT FK_3FBB7B953DA5256D FOREIGN KEY (image_id) REFERENCES media (id)');
        $this->addSql('ALTER TABLE slider_element ADD CONSTRAINT FK_3FBB7B9571F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slider_element DROP FOREIGN KEY FK_3FBB7B9571F7E88B');
