...
import { TableCell, TableRow, TableContainer, tableCellClasses } from '@mui/material';
...
export const SlotDiv = styled('div')(({ theme, slotIndex, color }) => ({
  position: "absolute",
  top: `${slotIndex * 25}%`,
  height: "25%",
  width: "80%",
  backgroundColor: color || theme.palette.dateStatus.valid,
  left: "10%",
  borderRadius: "0px",
}));
