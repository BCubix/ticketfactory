...
export const CmtEditMediaModal = ({ open, closeModal, selectedMedia, values, setFieldValue, name, updatedMedia, imageFormatList }) => {
    return (
                        ...
                        <Grid item xs={12} sm={6} md={5} sx={{ borderLeft: '1px solid #D3D3D3' }}>
                            ...
                            <Box display="flex" my={5}>
                                <Button
                                    ...
                                    color={'error'}
                                    onClick={() => {
                                        let newValue = values[name].filter((el) => el.id !== selectedMedia?.id);
