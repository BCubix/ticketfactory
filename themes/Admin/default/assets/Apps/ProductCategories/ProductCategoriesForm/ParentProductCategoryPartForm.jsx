...
export const ParentProductCategoryPartForm = ({ values, productCategoriesList, setFieldValue, touched, errors }) => {
    if (!productCategoriesList) {
        return <></>;
    }

    const defaultExpend = useMemo(() => {
        return getDefaultParentPath(productCategoriesList, values.parent);
    }, []);
