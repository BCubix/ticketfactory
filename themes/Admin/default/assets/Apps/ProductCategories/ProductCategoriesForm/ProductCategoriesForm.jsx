...
export const ProductCategoriesForm = ({ handleSubmit, parentId = null, initialValues = null, productCategoriesList = null, translateInitialValues = null }) => {
    ...
    return (
        ...
        >
            {({ values, errors, touched, handleChange, handleBlur, handleSubmit, setFieldValue, isSubmitting }) => (
                <Component.CmtPageWrapper component="form" onSubmit={handleSubmit} title={`${initialValues ? 'Modification' : 'Création'} d'une catégorie de produit`}>
                    <Component.CmtFormBlock title="Informations générales">
                        <Grid container spacing={4}>
                            ...
                            {values?.mustHaveParent && (
                                <Grid item xs={12}>
                                    <Component.ParentProductCategoryPartForm
                                        values={values}
