...
export const EditProductCategory = () => {
    ...
    return <Component.ProductCategoriesForm handleSubmit={handleSubmit} initialValues={productCategory} productCategoriesList={productCategoriesData?.productCategories} />;
};
