...
export const EventDateRange = React.memo(
    ({ open, setOpen, index, submitDateRange }) => {
    ...
    (prevProps, nextProps) => {
        return prevProps.open === nextProps.open && prevProps.index === nextProps.index && prevProps.submitDateRange === nextProps.submitDateRange;
    }
);
