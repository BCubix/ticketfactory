...
export const initMenu = ({ userRoles }) => {
    ...
    insertSubMenu(4, 'PARAMETRER', 'Types', Constant.CONTENT_TYPES_BASE_PATH, <WidgetsIcon />, { relatedLinks: [Constant.PAGE_BLOCK_TYPES_BASE_PATH] });
};
...
export const initTab = ({ userRoles }) => {
    ...
    addTabElements('contentTypesTabList', [{ label: 'Types de contenus', component: <Component.ContentTypesList />, path: Constant.CONTENT_TYPES_BASE_PATH }], 0);
};
