        ...
        <>
            ...
            <Component.CmtCard sx={{ marginTop: 4 }}>
                ...
                {data.notes && (
                    <Box sx={{ padding: 2 }}>
                        {editNote ? (
                            <Component.CmtTextField value={note} onChange={(e) => setNote(e.target.value)} multiline rows={4} />
                        ) : (
                            <Typography variant="body1" color="text.secondary">
                                {data.notes || 'Ceci est un espace dans lequel vous pouvez saisir vos notes pour ne rien oublier.'}
                            </Typography>
                        )}
